        ...
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <table class="tbl-30">
                ...
                <tr>
                    ...
                    <td>
                        <input type="number" name="price" id="price" oninput="calculateNewPrice()">
                    </td>
                </tr>
                <tr>
                    <td>Discount in Percentage: </td>
                    <td>
                        <input type="number" name="discount" id="discount" placeholder="In Percentage" oninput="calculateNewPrice() ">
                    </td>
                </tr>
                <tr>
                    <td>New Price: </td>
                    <td>
                        <input type="number" name="new_price" id="new_price" readonly>
                    </td>
                </tr>
